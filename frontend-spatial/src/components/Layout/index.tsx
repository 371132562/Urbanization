...
export const Component: FC = () => {
  ...
  return (
    <Layout className="h-screen w-full bg-purple-50">
      {/* 紫色政务风格顶部导航栏 */}
      <Header
        className="flex items-center px-8 text-white"
        style={{
          background: 'linear-gradient(135deg, #581c87 0%, #7c3aed 30%, #8b5cf6 70%, #a855f7 100%)',
      ...
      >
        ...
        <div className="flex items-center">
          <div className="text-2xl font-bold tracking-wide text-white">空间动力评价展示平台</div>
        </div>
      ...
      <Layout className="flex-grow">
        ...
        {/* 主内容区域 */}
        <Layout className="bg-purple-50">
          <Content className="!flex flex-grow flex-col p-7">
            {/* 紫色风格面包屑导航 */}
            <div className="mb-5 rounded-xl border-l-4 border-purple-500 bg-white px-5 py-3 shadow-md">
              <Breadcrumb
            ...
            <div className="flex-grow overflow-y-auto">
              <div className="min-h-full rounded-2xl border-2 border-purple-200 bg-white p-7 shadow-lg">
